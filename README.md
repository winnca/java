...
### Теория 
1. [Что за проект](#1-что-за-проект)
   - 1.1. [Архитектура проекта REST API](#11-архитектура-проекта-rest-api)
2. [Описание технологий проекта](#2-описание-технологий-проекта)
   - 2.0. [Из чего состоит проект](#20-из-чего-состоит-проект)
   - 2.1. [Для чего используют Maven](#21-для-чего-используют-maven)
   - 2.2. [Архитектура Spring Framework](#22-архитектура-spring-framework)
   - 2.3. [Spring Boot](#23-spring-boot)
   - 2.4. [Жизненный цикл Spring-приложения и управление бинами](#24-жизненный-цикл-spring-приложения-и-управление-бинами)
   - 2.5. [Жизненный цикл Spring-приложения (общий)](#25-жизненный-цикл-spring-приложения-общий)
   - 2.6. [Жизненный цикл Spring-бина](#26-жизненный-цикл-spring-бина)
   - 2.7. [Пример для нашего RESTful приложения](#27-пример-для-нашего-restful-приложения)
   - 2.8. [Как Spring обрабатывает HTTP-запрос и отправляет ответ](#28-как-spring-обрабатывает-http-запрос-и-отправляет-ответ)
3. [Зависимости проекта](#3-зависимости-проекта)
   - 3.1. [Spring Web](#31-spring-web)
   - 3.2. [Lombok](#32-lombok)
...
## 1.1. Архитектура проекта REST API
...
| **Model** | `ru.winnca.restcrud.students.model` | `@Entity` (для JPA) | Уровень **данных / сущностей**. Представляет, из чего состоит студент, какие у него атрибуты в таблице БД. |
...
## Важное замечание по приложению (REST API)
...
## 2. Описание технологий проекта

### 2.0. Из чего состоит проект
...
Существует также сборка **WAR** (Web Application ARchive):
...
### 2.2. Архитектура Spring Framework
...
- **Встроенные серверы (Embedded Servers)** — позволяет запускать приложение как самостоятельный JAR-файл со встроенным Tomcat. Не требуется устанавливать и настраивать отдельный веб-сервер.
...
### 2.4. Жизненный цикл Spring-приложения и управление бинами
...
### 2.5. Жизненный цикл Spring-приложения (общий)
...
### 2.6. Жизненный цикл Spring-бина (на примере `StudentController`)
...
### 2.7. Пример для нашего RESTful приложения
...
### 2.8. Как Spring обрабатывает HTTP-запрос и отправляет ответ
