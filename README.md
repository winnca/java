...
* ### [Часть 6: тестируем приложение](#title26)
...
## <a id="title26">Тестируем приложение</a>

32. Протестируем приложение с помощью Postman (не забудьте открыть pgAdmin4 и создать бд spring_security_db).
