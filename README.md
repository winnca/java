...
1. Создаём через start.spring.io zip-архив с проектом. Добавляем в него Spring Web. Скачиваем, разархиввируем, открываем с помощью Intellij IDEA.
...
7. Перед запуском убедитесь, что структура проект выглядит следующим образом:
